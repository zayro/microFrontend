...
export const lista_estado_estudio = [
...
// lista modalidad de estudio para selects
export const lista_modalidad_estudio = [
  { label: 'Virtual', value: '1' },
  { label: 'Presencial', value: '2' },
]

// Lista de países para selects
...
export const opcion_sn = [
  { label: 'SI', value: 'SI' },
  { label: 'NO', value: 'NO' },
]

export const opcion_tipo_moneda = [
  { label: 'EURO', value: 'SI' },
  { label: 'DOLAR', value: 'NO' },
]
...
export const lista_genero_identitario = [
  { label: 'Hombre Transgénero', value: '1' },
...
export const PepService = {
  ...
  getMini() {
    return Promise.resolve(this.getPepData().slice(0, 5))
  },

  getSmall() {
    return Promise.resolve(this.getPepData().slice(0, 10))
  },

  getAll() {
    return Promise.resolve(this.getPepData())
  },

  getCreateData(number) {
    const baseData = this.getPepData()[0]
